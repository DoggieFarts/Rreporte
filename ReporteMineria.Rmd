...
```
En el conjunto de datos original la variable del tamaño de la compañía venía representado con letras (L para un tamaño grande, M para mediano y S para chico) por lo que tuvimos que cambiarlo a números quedando de la forma (3 para un tamaño grande, 2 para mediano y 1 para chico). Ocurrió lo mismo para los valores de la variable experiencia, estos se generaron como sigue: SE con el número 1, MI con el 2, EN con el 3 y EX con el 4. Por último, para la variable de tipo de trabajo designamos que FT sería el 3, CT el 2 y FL el 1. Estos cambios de valores fueron hechos con la herramienta de buscar y reemplazar del editor de texto de RStudio.
### Modelado
